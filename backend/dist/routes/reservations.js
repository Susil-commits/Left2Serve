...
router.post('/', authMiddleware, roleMiddleware('ngo', 'volunteer'), validate(reservationSchema), async (req, res, next) => {
    try {
...
router.get('/listing/:listingId', authMiddleware, validateIdParam('listingId'), async (req, res, next) => {
    try {
...
router.get('/:id/qr-token', authMiddleware, validateIdParam('id'), async (req, res, next) => {
    try {
...
router.post('/verify-qr', authMiddleware, async (req, res, next) => {
    try {
...
router.patch('/:id', authMiddleware, validateIdParam('id'), async (req, res, next) => {
    try {
